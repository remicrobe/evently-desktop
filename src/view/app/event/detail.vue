<template>
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="text-left content-l-medium" style="color: #E5E5EA;">
                            {{ selectedEvent?.getFormattedDate() }}</p>
                    </div>
                    ...
                    <v-row>
                        <v-col md="12" cols="12" class="text-start">
                            <span class="content-xl-semibold">
                                {{ t('add_event_reccurence') }} : {{ t('global_' + selectedEvent?.recurrencePattern) }}
                            </span>
                        </v-col>
                    ...
                    <v-row class="mt-n2">
                        <v-col md="3" cols="3" class="text-start d-flex">
                            ...
                            >
                                <div style="background-color: rgba(232,213,213,0.5); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    <custom-icons
                                        :icon="category?.icon!"
                                        color="white"
                                        class="ma-2"
                                    ...
                                    <span class="content-m-bold mr-3">{{ category.default ? t(category.name!) : category.name! }}</span>
                                </div>
                            </div>
                        </v-col>
    ...
    <choose-clear class="cancel-button border-0 hide-mobile-icon" color="black-black100 pa-6" icon="chevronBack"
                  position="prepend" @click="router.back()">
        {{ t('global_back') }}
    </choose-clear>
...
const eventId = ref(Number(router.currentRoute.value.params.id))
...
const remainingTime = computed(() => {
    ...
    const targetDate = DateTime.fromJSDate(selectedEvent.value.targetDate!);
