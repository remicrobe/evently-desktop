<template>
    <div class="svg-icon" :style="{ width: size + 'px', height: size + 'px' }">
        <svg v-if="availableIcons[icon]" :width="size" :height="size" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask :id="`icon-mask${randomId}`" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <image :href="availableIcons[icon]" width="24" height="24" />
            </mask>
